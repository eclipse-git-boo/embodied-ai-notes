...
<figure class="paper-figure">
  <img src="{{ '/assets/paper-figures/samples/pi0-fig3-architecture-crop.png' | relative_url }}" alt="π0 模型框图">
  <figcaption>论文 Fig. 3（裁切）：这是理解 π0 的主框图；数据混合先训练 VLM 条件表示，连续 action expert 再承担动作生成。</figcaption>
</figure>
...
<figure class="paper-figure">
  <img src="{{ '/assets/paper-figures/samples/pi0-fig6-qualitative-crop.png' | relative_url }}" alt="裁切后的 π0 Fig. 6：零样本任务的定性评测轨迹">
  <figcaption>论文 Fig. 6（裁切）：多种零样本操作的定性评测轨迹。它展示任务广度，不能代替对成功率、试验次数和评测协议的量化比较。</figcaption>
</figure>
